...
//     var  promise       =  require( 'fs')            // .(40819.02.4 RAM Was: import { promises as fs } from 'fs')
//     var  fs            =  require( 'fs').promises ) // .(40819.02.4 RAM Was:    var   fs          = require('fs').promises) 
...
//  --------------------------------------------------------------
 ...
 if (typeof(vscode) == 'object')  {                                              // .(40819.10.5 RAM Need to reassign __basedir Beg)
        ...
        var  _TS       =   getDate() 
            console.log( `  AIC91[1]: __basedir is: '${__basedir}'`  )
...
//  export  default                                                                                 //#.(40819.03.3)
    var  pFRT =                                                                                     // .(40819.03.3 RAM Use for bothtypes of exports)
         {  setPaths, isCalled, listFiles, lastFile, getAPI: fetchFromOpenAI
         ,  getDate,  join: path.join, path: myPath, _TS, __basedir, __dirname                      // .(40819.10.x RAM Add them to FRT)  
...
//  export default pFRT                                                                             //#.(40819.03.4)  
