...
// import   FRT          from './AIC90_FileFns_u03.mjs'
      var   FRT       =  require( './AIC90_FileFns_u03.js' )                           // .(40819.02.3)
...
// import   dotenv       from 'dotenv';
      var   dotenv = require( 'dotenv' )
            ...
            console.log( "  Getting ", FRT.path( __basedir, '.env' )   )
...
//     var  __filename      =  import.meta.url                                           // .(40819.03.x RAM Defined in CommonJS)
...
//      if (aQuit == 'quit') {
        var aCR="\n"; // aQuit = ''
            ...
            if (aQuit == 'quit' && aCR == '') { deactivate() } //  process_.exit()                  // .(40819.09.x) }
//          }
//          console.log( `  nThread: '${mParms[0]}', nMsg: '${mParms[1]}',  aTS: '${mParms[2]}', aApp: '${mParms[3]}', aMod: '${mParms[4]}' ` )
    return  mParms
            }
...
//     export default                                                           //#.(40819.04.x RAM)
       var pAIM =  { setArgs, getApp, getModel, selectRow                       // .(40819.04.x RAM).(40711.01.2 RAM Add getApp).(40711.04.x RAM Add setArgs)
                   , getDocsPath, getModels, setEnv, add2Env                    // .(40727.03.3).(40722.04.x).(40715.04.5)
                   , getEnv }                                                   // .(40804.05.2)
//          export default pAIM                                                 //#.(40819.04.x RAM)
